...
Time <- c(2.022 , 3.027 , 4.018 , 4.043 , 4.086 , 4.129 , 4.168 , 4.204 , 
          
          2.022 , 3.032 , 4.026 , 4.176 , 4.348 , 4.663 , 4.999 , 
          
          2.021 , 3.021 , 4.035 , 4.33 , 4.66 , 5.015 , 5.506 , 
          
          2.02 , 3.02 , 4.03 , 4.5 , 5 , 5.5 , 6 , 
          
          3 , 5 , 6.04 , 6.08 , 6.13 , 6.2 , 
...
Data <- c( 0.606 , 0.623 , 0.711 , 0.566 , 0.283 , 0.156 , 0.128 , 0.088 , 
           
           2.191 , 2.281 , 2.148 , 0.672 , 0.283 , 0.186 , 0.128 , 
           
           15.993 , 19.767 , 10.431 , 2.913 , 0.587 , 1.014 , 0.149 , 
           
           61.689 , 75.813 , 66.705 , 41.15 , 28.356 , 22.328 , 13.742 , 
           
           0.553 , 0.419 , 0.364 , 0.137 , 0.071 , 0.036 , 
           
           37.13 , 39.375 , 32.927 , 13.125 , 10.407 , 2.329 , 
           
           0.57 , 0.72 , 0.54 , 0.26 , 0.12 , 0.06 , 
...
organs <- c(rep("Blood (venous)", 93), rep("Fat", 38), rep("Liver", 21),rep("Lung", 21),
            rep("Blood (venous)", 29), rep("Fat", 20))
Output_Var <- c(rep("CV", 93), rep("CFat", 38), rep("CLiv", 21),rep("CLung", 21),
            rep("CV", 29), rep("CFat", 20))
study <- c(rep("Tardiff, 2006", 53), 
           rep("Fuciarelli, 2000", 169))
dose <- c(rep("75 ppm, 4h, male", 8),
          rep("200 ppm, 4h, male", 7),
          rep("500 ppm, 4h, male", 7),
          rep("1000 ppm, 4h, male", 7),
          rep("75 ppm, 6h, male", 6),
          rep("750 ppm, 6h, male", 6),
          rep("75 ppm, 6h, female", 6),
...
ggsave(file = "plots/Figure_5A_MAP_Validation_Mouse.jpg", height = 12, width = 20, dpi = 600)
dev.off()
